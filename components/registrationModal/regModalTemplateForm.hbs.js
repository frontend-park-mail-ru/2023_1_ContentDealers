...
`
    ...
    <div class="passwordInputField">
        <input id="repeatedPasswordID" class="inputArea" type="password" maxlength="320" placeholder="Повторите пароль" value="">
    </div>
    <div class="submitRegForm">
        <button id="submitReg" disabled>Продолжить</button>
    </div>
`;
